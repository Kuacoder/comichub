                                                ...
                                                <div class="custom-tab user-profile-tab">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li role="presentation" class="active"><a href="#1"
                                                                aria-controls="1" role="tab" data-toggle="tab">Thông
                                                                tin chi tiết</a>
                                                        </li>
                                                    </ul>
                                                        ...
                                                        <div role="tabpanel" class="tab-pane active" id="1">
                                                            ...
                                                            <div class="basic-information">
																...
																$DateUpdate = Carbon::create($files->customer_update);
                                    								...
                                    								$DatecreatedFormat = $Datecreate->format('F.d,Y');
                                    								$DateUpdateformat = $DateUpdate->format('F.d,Y'); ?>
                                                                ...
                                                                <div class="gender-content">
                                                                    ...
                                                                    <span class="gender">@if($files->customer_gender
                                                                        ==0) Male @else Female @endif</span>
                                                                </div>
                                                                <div class="gender-content">
                                                                    <span class="contact-title">Ngày tạo:</span>
                                                                    <span class="gender"><?php $timestamp = $files->customer_date;
  																	echo(date("F.d, Y h:i:s", $timestamp)); ?></span>
                                                                </div>
                                                                <div class="gender-content">
                                                                    <span class="contact-title">Cập nhật lần
                                                                        cuối:</span>
                                                                    <span class="gender"><?php if($files->customer_update == 0){echo 'No';}else{$timestamp = $files->customer_update;
  																	echo(date("F.d, Y h:i:s", $timestamp)); }?></span>
                                                                </div>
                                                            </div>
                                                        </div>
