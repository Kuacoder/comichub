...
<div class="createcenter-body container-fluid">
    ...
    <div class="createcenter-body-content-home">
        ...
        <div class="createcenter-body-content-home_cover_img">
            <form action="{{URL::to('/add-coverimg-comic-client')}}" method="post" enctype="multipart/form-data"
                name="myForm">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <label class="anhbiatruyenvip">
                        <input type="radio" name="cover_img" value="{{$image->coverimg_picture}}" checked>
                ...
                <div class="focusthis">
                    ...
                    <p>5. <span>nghiêm cấm tải lên bất kỳ nội dung bất hopwj pháp nào như phản cảm, tục tĩu hoặc liên
                            quan đến chính trị...</span></p>
                </div>
                <div class="button button_vip_ia">
                    <a href="/back-to-add-comic-client/{{Session::get('session_id')}}">Quay lại</a>
